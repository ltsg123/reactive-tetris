...
exports.renderStop = exports.renderGameOver = exports.renderLeftoverBlocks = exports.renderBlock = exports.renderScore = exports.renderScene = exports.createCanvasElement = exports.CANVAS_HEIGHT = exports.CANVAS_WIDTH = exports.CELL_SIZE = exports.GAP_SIZE = exports.ROWS = exports.COLS = void 0;
exports.COLS = 25;
exports.ROWS = 40;
exports.GAP_SIZE = 1;
...
function renderScore(ctx, score) {
    var textX = exports.CANVAS_WIDTH / 2;
    var textY = exports.CANVAS_HEIGHT / 2;
    drawText(ctx, score.toString(), textX, textY, 'rgba(0, 0, 0, 0.1)', 150);
}
exports.renderScore = renderScore;
function renderBlock(ctx, blocks) {
    blocks.forEach(function (block) { return paintCell(ctx, block, 'red'); });
}
exports.renderBlock = renderBlock;
function renderLeftoverBlocks(ctx, blocks) {
    blocks.forEach(function (block) { return paintCell(ctx, block, 'black'); });
}
exports.renderLeftoverBlocks = renderLeftoverBlocks;
...
function paintCell(ctx, point, color) {
    var x = point.x * exports.CELL_SIZE + (point.x * exports.GAP_SIZE);
    var y = point.y * exports.CELL_SIZE + (point.y * exports.GAP_SIZE);
    ctx.fillStyle = color;
    ctx.fillRect(x, y, exports.CELL_SIZE, exports.CELL_SIZE);
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BLOCK = exports.DIRECTIONS = exports.UPROTATE_KEYDOWN = exports.SPACE = exports.FASTDOWN_KEYDOWN = exports.MOVE_KEYDOWN = exports.INIT_DOWN_RATE = exports.INITIAL_POSITION = exports.INITIAL_SCENE_BOTTOM_BORDER = exports.SPEED = exports.FPS = void 0;
var canvas_1 = __webpack_require__(/*! ./canvas */ "./canvas.ts");
exports.FPS = 100;
exports.SPEED = 500;
exports.INITIAL_SCENE_BOTTOM_BORDER = __spread(new Array(canvas_1.COLS).keys()).map(function (x) { return Object.assign({}, {
    x: x,
    y: 0
}); });
exports.INITIAL_POSITION = {
    x: canvas_1.COLS / 2,
    y: 0
};
// 初始下降流
exports.INIT_DOWN_RATE = {
    x: 0,
    y: 1
};
// 移动参数 37 = ⬅️； 39 = ➡️；
// 参考： https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/keyCode
exports.MOVE_KEYDOWN = {
    37: { x: -1, y: 0 },
    39: { x: 1, y: 0 },
    A: { x: -1, y: 0 },
    D: { x: 1, y: 0 }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.monitorBlocksTouchBottom = exports.getLowestPoint = exports.updateBorder = exports.isImpactBorder = exports.generateBlocks = exports.initBlocks = exports.rotate = exports.move = void 0;
var canvas_1 = __webpack_require__(/*! ./canvas */ "./canvas.ts");
 ...
 * @return {*}
 */
function move(blocks, direction, border) {
    var e_1, _a;
    var result = Array.from(blocks);
    try {
        for (var result_1 = __values(result), result_1_1 = result_1.next(); !result_1_1.done; result_1_1 = result_1.next()) {
            var iteroter = result_1_1.value;
            iteroter.x += 1 * direction.x;
            iteroter.y += 1 * direction.y;
            if (iteroter.x < 0) {
                iteroter.x += canvas_1.COLS;
            }
            else if (iteroter.x > canvas_1.COLS - 1) {
                iteroter.x -= canvas_1.COLS;
            }
        }
    }
...
function rotate(blocks, border) {
    ...
    blocks.forEach(function (block, index) {
        if (index === 1) {
            ...
            var x = (block.x - refPoint.x) * 0 - (block.y - refPoint.y) * 1 + refPoint.x;
            var y = (block.y - refPoint.y) * 0 + (block.x - refPoint.x) * 1 + refPoint.y;
            resultBlocks.push({ x: x, y: y });
        }
    });
...
function initBlocks() {
    var maxNum = Object.keys(constants_1.BLOCK).length - 1;
    var randomNum = parseInt(Math.random() * (maxNum + 1) + '', 10);
    return Array.from(constants_1.BLOCK[randomNum]);
}
exports.initBlocks = initBlocks;
function generateBlocks(blocks) {
    var maxNum = Object.keys(constants_1.BLOCK).length - 1;
    var randomNum = parseInt(Math.random() * (maxNum + 1) + '', 10);
    var xRandom = parseInt(Math.random() * (canvas_1.COLS + 1) + '', 10);
    return Array.from(blocks !== null && blocks !== void 0 ? blocks : constants_1.BLOCK[randomNum], function (v) { return Object.assign({}, {
        x: v.x + xRandom,
        y: v.y
    }); });
}
exports.generateBlocks = generateBlocks;
function isImpactBorder(border, blocks) {
    return border.some(function (item) { return blocks.some(function (block) { return block.y >= canvas_1.ROWS; }) || blocks.includes(item); });
}
exports.isImpactBorder = isImpactBorder;
/**
 ...
 */
function updateBorder(border, merge, blockPos$, nextBlock) {
    var blocks = monitorBlocksTouchBottom(border, merge);
    if (blocks.length > 0) {
        var mergeBorder_1 = __spread(blocks, border);
        var heights = Array.from(new Set(blocks.map(function (point) { return point.y; })));
        heights.forEach(function (height) {
            var length = mergeBorder_1.filter(function (point) { return point.y === height; }).length;
            if (length === canvas_1.COLS) {
                mergeBorder_1 = mergeBorder_1.filter(function (point) { return point.y !== height; });
                mergeBorder_1 = mergeBorder_1.map(function (point) {
                    if (point.y < height) {
                        return {
                            x: point.x,
                            y: point.y + 1
        ...
        return mergeBorder_1;
    }
    return border;
}
exports.updateBorder = updateBorder;
/**
 ...
 * @param {Array<Point2D>} blocks
 */
function getLowestPoint(blocks) {
    var lowestPoints = [blocks[0]];
...
exports.getLowestPoint = getLowestPoint;
/**
 ...
 * @param {Array<Point2D>} border
 */
function monitorBlocksTouchBottom(border, blocks) {
    if (blocks.length === 0) {
        return [];
    }
    var isTouched = blocks.some(function (block) { return block.y === canvas_1.ROWS - 1 || border.find(function (item) { return item.x === block.x && item.y === block.y + 1; }); });
    return isTouched ? blocks : [];
}
exports.monitorBlocksTouchBottom = monitorBlocksTouchBottom;
...
var merge_2 = __webpack_require__(/*! ../operators/merge */ "../node_modules/rxjs/operators/merge.js");
...
var auditTime_1 = __webpack_require__(/*! ./auditTime */ "../node_modules/rxjs/operators/auditTime.js");
exports.auditTime = auditTime_1.auditTime;
var buffer_1 = __webpack_require__(/*! ./buffer */ "../node_modules/rxjs/operators/buffer.js");
exports.buffer = buffer_1.buffer;
var bufferCount_1 = __webpack_require__(/*! ./bufferCount */ "../node_modules/rxjs/operators/bufferCount.js");
exports.bufferCount = bufferCount_1.bufferCount;
var bufferTime_1 = __webpack_require__(/*! ./bufferTime */ "../node_modules/rxjs/operators/bufferTime.js");
exports.bufferTime = bufferTime_1.bufferTime;
var bufferToggle_1 = __webpack_require__(/*! ./bufferToggle */ "../node_modules/rxjs/operators/bufferToggle.js");
exports.bufferToggle = bufferToggle_1.bufferToggle;
var bufferWhen_1 = __webpack_require__(/*! ./bufferWhen */ "../node_modules/rxjs/operators/bufferWhen.js");
exports.bufferWhen = bufferWhen_1.bufferWhen;
var catchError_1 = __webpack_require__(/*! ./catchError */ "../node_modules/rxjs/operators/catchError.js");
exports.catchError = catchError_1.catchError;
var combineAll_1 = __webpack_require__(/*! ./combineAll */ "../node_modules/rxjs/operators/combineAll.js");
exports.combineAll = combineAll_1.combineAll;
var combineLatest_1 = __webpack_require__(/*! ./combineLatest */ "../node_modules/rxjs/operators/combineLatest.js");
exports.combineLatest = combineLatest_1.combineLatest;
var concat_1 = __webpack_require__(/*! ./concat */ "../node_modules/rxjs/operators/concat.js");
exports.concat = concat_1.concat;
var concatAll_1 = __webpack_require__(/*! ./concatAll */ "../node_modules/rxjs/operators/concatAll.js");
exports.concatAll = concatAll_1.concatAll;
var concatMap_1 = __webpack_require__(/*! ./concatMap */ "../node_modules/rxjs/operators/concatMap.js");
exports.concatMap = concatMap_1.concatMap;
var concatMapTo_1 = __webpack_require__(/*! ./concatMapTo */ "../node_modules/rxjs/operators/concatMapTo.js");
exports.concatMapTo = concatMapTo_1.concatMapTo;
var count_1 = __webpack_require__(/*! ./count */ "../node_modules/rxjs/operators/count.js");
exports.count = count_1.count;
var debounce_1 = __webpack_require__(/*! ./debounce */ "../node_modules/rxjs/operators/debounce.js");
exports.debounce = debounce_1.debounce;
var debounceTime_1 = __webpack_require__(/*! ./debounceTime */ "../node_modules/rxjs/operators/debounceTime.js");
exports.debounceTime = debounceTime_1.debounceTime;
var defaultIfEmpty_1 = __webpack_require__(/*! ./defaultIfEmpty */ "../node_modules/rxjs/operators/defaultIfEmpty.js");
exports.defaultIfEmpty = defaultIfEmpty_1.defaultIfEmpty;
var delay_1 = __webpack_require__(/*! ./delay */ "../node_modules/rxjs/operators/delay.js");
exports.delay = delay_1.delay;
var delayWhen_1 = __webpack_require__(/*! ./delayWhen */ "../node_modules/rxjs/operators/delayWhen.js");
exports.delayWhen = delayWhen_1.delayWhen;
var dematerialize_1 = __webpack_require__(/*! ./dematerialize */ "../node_modules/rxjs/operators/dematerialize.js");
exports.dematerialize = dematerialize_1.dematerialize;
var distinct_1 = __webpack_require__(/*! ./distinct */ "../node_modules/rxjs/operators/distinct.js");
exports.distinct = distinct_1.distinct;
var distinctUntilChanged_1 = __webpack_require__(/*! ./distinctUntilChanged */ "../node_modules/rxjs/operators/distinctUntilChanged.js");
exports.distinctUntilChanged = distinctUntilChanged_1.distinctUntilChanged;
var distinctUntilKeyChanged_1 = __webpack_require__(/*! ./distinctUntilKeyChanged */ "../node_modules/rxjs/operators/distinctUntilKeyChanged.js");
exports.distinctUntilKeyChanged = distinctUntilKeyChanged_1.distinctUntilKeyChanged;
var elementAt_1 = __webpack_require__(/*! ./elementAt */ "../node_modules/rxjs/operators/elementAt.js");
exports.elementAt = elementAt_1.elementAt;
var every_1 = __webpack_require__(/*! ./every */ "../node_modules/rxjs/operators/every.js");
exports.every = every_1.every;
var exhaust_1 = __webpack_require__(/*! ./exhaust */ "../node_modules/rxjs/operators/exhaust.js");
exports.exhaust = exhaust_1.exhaust;
var exhaustMap_1 = __webpack_require__(/*! ./exhaustMap */ "../node_modules/rxjs/operators/exhaustMap.js");
exports.exhaustMap = exhaustMap_1.exhaustMap;
var expand_1 = __webpack_require__(/*! ./expand */ "../node_modules/rxjs/operators/expand.js");
exports.expand = expand_1.expand;
var filter_1 = __webpack_require__(/*! ./filter */ "../node_modules/rxjs/operators/filter.js");
exports.filter = filter_1.filter;
var finalize_1 = __webpack_require__(/*! ./finalize */ "../node_modules/rxjs/operators/finalize.js");
exports.finalize = finalize_1.finalize;
var find_1 = __webpack_require__(/*! ./find */ "../node_modules/rxjs/operators/find.js");
exports.find = find_1.find;
var findIndex_1 = __webpack_require__(/*! ./findIndex */ "../node_modules/rxjs/operators/findIndex.js");
exports.findIndex = findIndex_1.findIndex;
var first_1 = __webpack_require__(/*! ./first */ "../node_modules/rxjs/operators/first.js");
exports.first = first_1.first;
var groupBy_1 = __webpack_require__(/*! ./groupBy */ "../node_modules/rxjs/operators/groupBy.js");
exports.groupBy = groupBy_1.groupBy;
var ignoreElements_1 = __webpack_require__(/*! ./ignoreElements */ "../node_modules/rxjs/operators/ignoreElements.js");
exports.ignoreElements = ignoreElements_1.ignoreElements;
var isEmpty_1 = __webpack_require__(/*! ./isEmpty */ "../node_modules/rxjs/operators/isEmpty.js");
exports.isEmpty = isEmpty_1.isEmpty;
var last_1 = __webpack_require__(/*! ./last */ "../node_modules/rxjs/operators/last.js");
exports.last = last_1.last;
var map_1 = __webpack_require__(/*! ./map */ "../node_modules/rxjs/operators/map.js");
exports.map = map_1.map;
var mapTo_1 = __webpack_require__(/*! ./mapTo */ "../node_modules/rxjs/operators/mapTo.js");
exports.mapTo = mapTo_1.mapTo;
var materialize_1 = __webpack_require__(/*! ./materialize */ "../node_modules/rxjs/operators/materialize.js");
exports.materialize = materialize_1.materialize;
var max_1 = __webpack_require__(/*! ./max */ "../node_modules/rxjs/operators/max.js");
exports.max = max_1.max;
var merge_1 = __webpack_require__(/*! ./merge */ "../node_modules/rxjs/operators/merge.js");
exports.merge = merge_1.merge;
var mergeAll_1 = __webpack_require__(/*! ./mergeAll */ "../node_modules/rxjs/operators/mergeAll.js");
exports.mergeAll = mergeAll_1.mergeAll;
var mergeMap_1 = __webpack_require__(/*! ./mergeMap */ "../node_modules/rxjs/operators/mergeMap.js");
exports.mergeMap = mergeMap_1.mergeMap;
var mergeMap_2 = __webpack_require__(/*! ./mergeMap */ "../node_modules/rxjs/operators/mergeMap.js");
exports.flatMap = mergeMap_2.mergeMap;
var mergeMapTo_1 = __webpack_require__(/*! ./mergeMapTo */ "../node_modules/rxjs/operators/mergeMapTo.js");
exports.mergeMapTo = mergeMapTo_1.mergeMapTo;
var mergeScan_1 = __webpack_require__(/*! ./mergeScan */ "../node_modules/rxjs/operators/mergeScan.js");
exports.mergeScan = mergeScan_1.mergeScan;
var min_1 = __webpack_require__(/*! ./min */ "../node_modules/rxjs/operators/min.js");
exports.min = min_1.min;
var multicast_1 = __webpack_require__(/*! ./multicast */ "../node_modules/rxjs/operators/multicast.js");
exports.multicast = multicast_1.multicast;
var observeOn_1 = __webpack_require__(/*! ./observeOn */ "../node_modules/rxjs/operators/observeOn.js");
exports.observeOn = observeOn_1.observeOn;
var onErrorResumeNext_1 = __webpack_require__(/*! ./onErrorResumeNext */ "../node_modules/rxjs/operators/onErrorResumeNext.js");
exports.onErrorResumeNext = onErrorResumeNext_1.onErrorResumeNext;
var pairwise_1 = __webpack_require__(/*! ./pairwise */ "../node_modules/rxjs/operators/pairwise.js");
exports.pairwise = pairwise_1.pairwise;
var partition_1 = __webpack_require__(/*! ./partition */ "../node_modules/rxjs/operators/partition.js");
exports.partition = partition_1.partition;
var pluck_1 = __webpack_require__(/*! ./pluck */ "../node_modules/rxjs/operators/pluck.js");
exports.pluck = pluck_1.pluck;
var publish_1 = __webpack_require__(/*! ./publish */ "../node_modules/rxjs/operators/publish.js");
exports.publish = publish_1.publish;
var publishBehavior_1 = __webpack_require__(/*! ./publishBehavior */ "../node_modules/rxjs/operators/publishBehavior.js");
exports.publishBehavior = publishBehavior_1.publishBehavior;
var publishLast_1 = __webpack_require__(/*! ./publishLast */ "../node_modules/rxjs/operators/publishLast.js");
exports.publishLast = publishLast_1.publishLast;
var publishReplay_1 = __webpack_require__(/*! ./publishReplay */ "../node_modules/rxjs/operators/publishReplay.js");
exports.publishReplay = publishReplay_1.publishReplay;
var race_1 = __webpack_require__(/*! ./race */ "../node_modules/rxjs/operators/race.js");
exports.race = race_1.race;
var reduce_1 = __webpack_require__(/*! ./reduce */ "../node_modules/rxjs/operators/reduce.js");
exports.reduce = reduce_1.reduce;
var repeat_1 = __webpack_require__(/*! ./repeat */ "../node_modules/rxjs/operators/repeat.js");
exports.repeat = repeat_1.repeat;
var repeatWhen_1 = __webpack_require__(/*! ./repeatWhen */ "../node_modules/rxjs/operators/repeatWhen.js");
exports.repeatWhen = repeatWhen_1.repeatWhen;
var retry_1 = __webpack_require__(/*! ./retry */ "../node_modules/rxjs/operators/retry.js");
exports.retry = retry_1.retry;
var retryWhen_1 = __webpack_require__(/*! ./retryWhen */ "../node_modules/rxjs/operators/retryWhen.js");
exports.retryWhen = retryWhen_1.retryWhen;
var refCount_1 = __webpack_require__(/*! ./refCount */ "../node_modules/rxjs/operators/refCount.js");
exports.refCount = refCount_1.refCount;
var sample_1 = __webpack_require__(/*! ./sample */ "../node_modules/rxjs/operators/sample.js");
exports.sample = sample_1.sample;
var sampleTime_1 = __webpack_require__(/*! ./sampleTime */ "../node_modules/rxjs/operators/sampleTime.js");
exports.sampleTime = sampleTime_1.sampleTime;
var scan_1 = __webpack_require__(/*! ./scan */ "../node_modules/rxjs/operators/scan.js");
exports.scan = scan_1.scan;
var sequenceEqual_1 = __webpack_require__(/*! ./sequenceEqual */ "../node_modules/rxjs/operators/sequenceEqual.js");
exports.sequenceEqual = sequenceEqual_1.sequenceEqual;
var share_1 = __webpack_require__(/*! ./share */ "../node_modules/rxjs/operators/share.js");
exports.share = share_1.share;
var shareReplay_1 = __webpack_require__(/*! ./shareReplay */ "../node_modules/rxjs/operators/shareReplay.js");
exports.shareReplay = shareReplay_1.shareReplay;
var single_1 = __webpack_require__(/*! ./single */ "../node_modules/rxjs/operators/single.js");
exports.single = single_1.single;
var skip_1 = __webpack_require__(/*! ./skip */ "../node_modules/rxjs/operators/skip.js");
exports.skip = skip_1.skip;
var skipLast_1 = __webpack_require__(/*! ./skipLast */ "../node_modules/rxjs/operators/skipLast.js");
exports.skipLast = skipLast_1.skipLast;
var skipUntil_1 = __webpack_require__(/*! ./skipUntil */ "../node_modules/rxjs/operators/skipUntil.js");
exports.skipUntil = skipUntil_1.skipUntil;
var skipWhile_1 = __webpack_require__(/*! ./skipWhile */ "../node_modules/rxjs/operators/skipWhile.js");
exports.skipWhile = skipWhile_1.skipWhile;
var startWith_1 = __webpack_require__(/*! ./startWith */ "../node_modules/rxjs/operators/startWith.js");
...
var switchAll_1 = __webpack_require__(/*! ./switchAll */ "../node_modules/rxjs/operators/switchAll.js");
exports.switchAll = switchAll_1.switchAll;
var switchMap_1 = __webpack_require__(/*! ./switchMap */ "../node_modules/rxjs/operators/switchMap.js");
exports.switchMap = switchMap_1.switchMap;
var switchMapTo_1 = __webpack_require__(/*! ./switchMapTo */ "../node_modules/rxjs/operators/switchMapTo.js");
exports.switchMapTo = switchMapTo_1.switchMapTo;
var take_1 = __webpack_require__(/*! ./take */ "../node_modules/rxjs/operators/take.js");
exports.take = take_1.take;
var takeLast_1 = __webpack_require__(/*! ./takeLast */ "../node_modules/rxjs/operators/takeLast.js");
exports.takeLast = takeLast_1.takeLast;
var takeUntil_1 = __webpack_require__(/*! ./takeUntil */ "../node_modules/rxjs/operators/takeUntil.js");
exports.takeUntil = takeUntil_1.takeUntil;
var takeWhile_1 = __webpack_require__(/*! ./takeWhile */ "../node_modules/rxjs/operators/takeWhile.js");
exports.takeWhile = takeWhile_1.takeWhile;
var tap_1 = __webpack_require__(/*! ./tap */ "../node_modules/rxjs/operators/tap.js");
exports.tap = tap_1.tap;
var throttle_1 = __webpack_require__(/*! ./throttle */ "../node_modules/rxjs/operators/throttle.js");
exports.throttle = throttle_1.throttle;
var throttleTime_1 = __webpack_require__(/*! ./throttleTime */ "../node_modules/rxjs/operators/throttleTime.js");
exports.throttleTime = throttleTime_1.throttleTime;
var timeInterval_1 = __webpack_require__(/*! ./timeInterval */ "../node_modules/rxjs/operators/timeInterval.js");
exports.timeInterval = timeInterval_1.timeInterval;
var timeout_1 = __webpack_require__(/*! ./timeout */ "../node_modules/rxjs/operators/timeout.js");
exports.timeout = timeout_1.timeout;
var timeoutWith_1 = __webpack_require__(/*! ./timeoutWith */ "../node_modules/rxjs/operators/timeoutWith.js");
exports.timeoutWith = timeoutWith_1.timeoutWith;
var timestamp_1 = __webpack_require__(/*! ./timestamp */ "../node_modules/rxjs/operators/timestamp.js");
exports.timestamp = timestamp_1.timestamp;
var toArray_1 = __webpack_require__(/*! ./toArray */ "../node_modules/rxjs/operators/toArray.js");
exports.toArray = toArray_1.toArray;
var window_1 = __webpack_require__(/*! ./window */ "../node_modules/rxjs/operators/window.js");
exports.window = window_1.window;
var windowCount_1 = __webpack_require__(/*! ./windowCount */ "../node_modules/rxjs/operators/windowCount.js");
exports.windowCount = windowCount_1.windowCount;
var windowTime_1 = __webpack_require__(/*! ./windowTime */ "../node_modules/rxjs/operators/windowTime.js");
exports.windowTime = windowTime_1.windowTime;
var windowToggle_1 = __webpack_require__(/*! ./windowToggle */ "../node_modules/rxjs/operators/windowToggle.js");
exports.windowToggle = windowToggle_1.windowToggle;
var windowWhen_1 = __webpack_require__(/*! ./windowWhen */ "../node_modules/rxjs/operators/windowWhen.js");
exports.windowWhen = windowWhen_1.windowWhen;
var withLatestFrom_1 = __webpack_require__(/*! ./withLatestFrom */ "../node_modules/rxjs/operators/withLatestFrom.js");
exports.withLatestFrom = withLatestFrom_1.withLatestFrom;
var zip_1 = __webpack_require__(/*! ./zip */ "../node_modules/rxjs/operators/zip.js");
exports.zip = zip_1.zip;
var zipAll_1 = __webpack_require__(/*! ./zipAll */ "../node_modules/rxjs/operators/zipAll.js");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var interval_1 = __webpack_require__(/*! rxjs/observable/interval */ "../node_modules/rxjs/observable/interval.js");
var of_1 = __webpack_require__(/*! rxjs/observable/of */ "../node_modules/rxjs/observable/of.js");
var operators_1 = __webpack_require__(/*! rxjs/operators */ "../node_modules/rxjs/operators/index.js");
var canvas_1 = __webpack_require__(/*! ./canvas */ "./canvas.ts");
var constants_1 = __webpack_require__(/*! ./constants */ "./constants.ts");
var animationFrame_1 = __webpack_require__(/*! rxjs/scheduler/animationFrame */ "../node_modules/rxjs/scheduler/animationFrame.js");
...
var combineLatest_1 = __webpack_require__(/*! rxjs/observable/combineLatest */ "../node_modules/rxjs/observable/combineLatest.js");
 ...
 */
var canvas = canvas_1.createCanvasElement(canvas_1.CANVAS_WIDTH, canvas_1.CANVAS_HEIGHT);
...
var ticks$ = interval_1.interval(constants_1.SPEED);
var keydown$ = fromEvent_1.fromEvent(document, 'keydown');
function createGame(fps$) {
    var stopState$ = new BehaviorSubject_1.BehaviorSubject(false);
    var stop$ = keydown$.pipe(operators_1.map(function (event) { return constants_1.SPACE[event.keyCode]; }), operators_1.filter(function (direction) { return !!direction; }), operators_1.tap(function () { return stopState$.next(!stopState$.value); }));
    // 记录方块各种变化后的位置
    var blockPos$ = new BehaviorSubject_1.BehaviorSubject(utils_1.generateBlocks());
    // 记录方块底部边界
    var borderBlocks$ = new BehaviorSubject_1.BehaviorSubject([]);
    // 方块快速下降
    var fastDown$ = keydown$.pipe(operators_1.filter(function () { return !stopState$.value; }), operators_1.map(function (event) { return constants_1.FASTDOWN_KEYDOWN[event.keyCode]; }), operators_1.filter(function (direction) { return !!direction; }));
    // 方块初始下降--源流
    var block$ = merge_1.merge(ticks$, fastDown$, stop$).pipe(operators_1.filter(function () { return !stopState$.value; }), operators_1.withLatestFrom(blockPos$, borderBlocks$, function (_, blockPos, border) { return utils_1.move(blockPos, constants_1.INIT_DOWN_RATE, border); }), operators_1.tap(function (block) { return blockPos$.next(block); }), operators_1.share());
    // 方块左右移动源
    var move$ = keydown$.pipe(operators_1.filter(function () { return !stopState$.value; }), operators_1.map(function (event) { return constants_1.MOVE_KEYDOWN[event.keyCode]; }), operators_1.filter(function (direction) { return !!direction; }), operators_1.withLatestFrom(blockPos$, borderBlocks$, function (_, blockPos, border) { return utils_1.move(blockPos, _, border); }), operators_1.share());
    // 方块向上旋转
    var upRotate$ = keydown$.pipe(operators_1.filter(function () { return !stopState$.value; }), operators_1.map(function (event) { return constants_1.UPROTATE_KEYDOWN[event.keyCode]; }), operators_1.filter(function (direction) { return !!direction; }), operators_1.withLatestFrom(blockPos$, borderBlocks$, function (_, blockPos, border) { return utils_1.rotate(blockPos, border); }), operators_1.tap(function (block) { return blockPos$.next(block); }), operators_1.share());
    var blockChanges$ = merge_1.merge(block$, move$, upRotate$);
    var sceneBottomBorder$ = block$.pipe(operators_1.scan(function (border, blocks) { return utils_1.updateBorder(border, blocks, blockPos$); }, []), operators_1.tap(function (border) { return borderBlocks$.next(border); }), operators_1.share());
    var score$ = sceneBottomBorder$.pipe(operators_1.map(function (points) { return points.length; }), operators_1.startWith(0), operators_1.share());
    var scene$ = combineLatest_1.combineLatest(blockChanges$, sceneBottomBorder$, score$, stopState$, function (block, leftoverBlocks, score, stopState, _) {
        return {
            block: block, leftoverBlocks: leftoverBlocks, score: score,
            isStop: stopState
        };
    });
    return fps$.pipe(operators_1.withLatestFrom(scene$, function (_, scene) { return scene; }));
}
function isGameOver(scene) {
    return scene.leftoverBlocks.some(function (item) { return item.y < 0; });
}
var game$ = of_1.of('Start Game').pipe(operators_1.map(function () { return interval_1.interval(1000 / constants_1.FPS, animationFrame_1.animationFrame); }), operators_1.switchMap(createGame), operators_1.takeWhile(function (scene) { return !isGameOver(scene); }));
var startGame = function () { return game$.subscribe({
    next: function (scene) {
        canvas_1.renderScene(ctx, scene);
        scene.isStop && canvas_1.renderStop(ctx);
    },
    complete: function () {
        canvas_1.renderGameOver(ctx);
    }
}); };
startGame();
